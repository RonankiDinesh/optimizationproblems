...
- The problem of determining $C_2$ is known to be equivalent to [Erdős problem #36](https://www.erdosproblems.com/36).  That is to say, $C_2$ is known [H2016] to also be largest constant such that, whenever $N$ is large and $\{1,\dots,2N\}$ is partitioned into two equal subsets $A,B$, then there is an $x$ such that there are $\geq (C_2 - o(1))N$ solutions to $a-b=x$ with $a \in A$ and $b \in B$.
