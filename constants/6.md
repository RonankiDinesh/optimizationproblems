...
$C_6$ is the largest constant such that any union-closed family of sets on an $N$-element ground set has an element contained in at least $C_6$ fraction of the sets.
