...
$C_4$ is the largest constant such that, for large $n$, there exists subsets of $\mathbb{F}_3^n$ of cardinality $(C_4-o(1))^n$ that are _cap sets_, i.e., they do not contain any lines (length three progressions).
...
- Any cap set $A$ in $\mathbb{F}_3^n$ gives a lower bound $C_4 \geq \lvert A\rvert^{1/n}$ by taking Cartesian powers.
