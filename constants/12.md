...
$C_{12} = \beta_2$ is the constant such that the length $L_n$ of the shortest tour through $n$ independent uniform random points satisfies $L_n/\sqrt{n}\to \beta_2$ almost surely.
