...
where the supremum ranges over all $n\geq 2$ and all Boolean functions $f : \{0,1\}^{n} \to \{0,1\}$ with $\deg(f)>1$.
...
| ----- | --------- | -------- |
| $2$ | [NS1994], [T2013] | One has $s(f)\le bs(f)$ and $bs(f)\le O(\deg(f)^2)$, giving an exponent upper bound $C_{36}\le 2$. |
