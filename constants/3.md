# A sum-difference constant

## Description of constant

$C_3$ is the largest constant such that there exist arbitrarily large sets $A,B$ of integers such that
$$ |A+B| \ll |A|$$
and
$$ |A-B| \gg |A+B|^{C_3}.$$
...
- Thanks to a lemma from [GHR2007], any finite set $U$ of non-negative integers containing zero yields a lower bound of the form $1 + \log(|U-U|/|U+U|)/\log(2 \max(U)+1)$ for $C_3$. However, the lower bounds obtained in this fashion cannot exceed $1.25$.
